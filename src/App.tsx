...
const PROJECTS = [
  ...
  description: 'Full-stack agentic RAG application for document intelligence. A LangGraph-based system classifies intent, retrieves relevant context, and routes to Q&A, summarization, quiz generation, or topic extraction — with a relevance-gated grounding check that blocks hallucinated answers before generation. Instrumented with Langfuse for full observability and a regression eval harness, and exposed as an MCP server for use with Claude Desktop and other MCP clients. Built solo from system design to production deployment.',
  stack: ['Python', 'FastAPI', 'LangGraph', 'LangChain', 'Groq API', 'ChromaDB', 'HuggingFace', 'MCP', 'Langfuse', 'React', 'TypeScript'],
